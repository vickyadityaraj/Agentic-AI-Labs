...
└── Lab_Experiments/                           # 📂 Laboratory Experiments Folder
    ...
    │   ├── Experiment_1_Text_to_SQL_Groq.py
    │   ├── Experiment_2_RAG_QA_Groq.py
    │   └── Experiment_3_Prompt_Chaining_Groq.py
    │
    └── Documents/                             # 📄 Experiment Documentation & Reports
...
```bash
python Lab_Experiments/Programs/Experiment_1_Text_to_SQL_Groq.py
```
...
```bash
python Lab_Experiments/Programs/Experiment_2_RAG_QA_Groq.py
```
...
```bash
python Lab_Experiments/Programs/Experiment_3_Prompt_Chaining_Groq.py
```
